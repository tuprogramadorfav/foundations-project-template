...
class Atleta(db.Model, UserMixin):
    ...
    academy_id = db.Column(db.Integer, db.ForeignKey(
        'academy.id'), nullable=False)
...
class Gender(db.Model):
    ...
    weight_agedivision_genders = db.relationship(
        'Weight_age_division_gender', back_populates='gender')
...
class Belt(db.Model):
    ...
    age_division_belt = db.relationship(
        'Age_division_belt', back_populates='belt')
...
class Registration(db.Model):
    ...
    atleta_id = db.Column(db.Integer, db.ForeignKey(
        'atleta.id'), nullable=False)
    event_id = db.Column(db.Integer, db.ForeignKey('event.id'), nullable=False)
    age_division_id = db.Column(db.Integer, db.ForeignKey(
        'age_division.id'), nullable=False)
...
class Age_division(db.Model):
    ...
    registration = db.relationship(
        'Registration', backref='age_division', lazy=True)
    weight_agedivision_genders = db.relationship(
        'Weight_age_division_gender', back_populates='age_division')
    age_division_belt = db.relationship(
        'Age_division_belt', back_populates='age_division')
...
class Weight(db.Model):
    ...
    kimono = db.Column(db.Boolean, nullable=False)
    registrations = db.relationship(
        'Registration', backref='weight', lazy=True)
    weight_agedivision_genders = db.relationship(
        'Weight_age_division_gender', back_populates='weight')
...
class Weight_age_division_gender(db.Model):
    ...
    weight = db.relationship(
        'Weight', back_populates='weight_agedivision_genders')
    age_division = db.relationship(
        'Age_division', back_populates='weight_agedivision_genders')
    gender = db.relationship(
        'Gender', back_populates='weight_agedivision_genders')
...
class Age_division_belt(db.Model):
    ...
    age_division = db.relationship(
        'Age_division', back_populates='age_division_belt')
